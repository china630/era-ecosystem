...
/**
 * Ensures listed users exist with `isSuperAdmin: true` (Finance DB during legacy auth).
 * Orchestrator is canonical IdP — keep both DBs in sync via `tools/bootstrap-local.mjs`.
 */
