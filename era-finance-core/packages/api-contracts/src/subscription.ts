...
export const OrganizationModuleEntitlementsSchema = z.object({
  ...
  tradePro: z.boolean(),
  auditHub: z.boolean(),
  tradeCreditControl: z.boolean().optional(),
  compliancePro: z.boolean(),
  industryRetail: z.boolean().optional(),
  industryLogistics: z.boolean().optional(),
  industryConstruction: z.boolean().optional(),
  industryCrm: z.boolean().optional(),
  industryAutoService: z.boolean().optional(),
  industryClinic: z.boolean().optional(),
  industryWholesale: z.boolean().optional(),
  industryHotelPms: z.boolean().optional(),
  industryFnbPos: z.boolean().optional(),
  /** @deprecated One-release alias — same as industryRetail */
  ...
  industryFbPos: z.boolean().optional(),
});
