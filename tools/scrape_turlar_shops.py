#!/usr/bin/env python3
"""Scrape travel agency profiles from https://turlar.az/shops"""
...
OUT_CSV = OUT_DIR / "azerbaijan-turlar-shops.csv"
BASE = "https://turlar.az/shops"
...
def parse_page(html: str) -> list[dict]:
    ...
    for block in re.findall(r'<div class="campdiv clearfix">(.*?)</div>\s*</div>', html, re.S):
        ...
        profile_url = "https://turlar.az" + profile_path
