...
const SATELLITES = [
  ...
  {
    dir: "era-auto-service",
    name: "era-auto-service",
    title: "ERA Auto STO",
    port: 3304,
    host: "auto-service.era-365.online",
    db: "era_auto_service",
