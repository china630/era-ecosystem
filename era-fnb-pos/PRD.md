...
> Детальная спека: [doc/README.md](./doc/README.md) · DELIVERY: [doc/DELIVERY-FB.md](./doc/DELIVERY-FB.md) · PMS bridge: [era-hotel-pms/doc/openapi/fnb-pos-pms-bridge.yaml](../era-hotel-pms/doc/openapi/fnb-pos-pms-bridge.yaml)

| Параметр | Значение |
|----------|----------|
| **Продукт** | ERA F&B POS (`era-fnb-pos`) |
| **Host** | `fnb-pos.era-365.online` (3200) |
...
**era-fnb-pos** — облачный F&B POS: floor map, ticket, KDS, payments, Z-close. Оплата «на номер» — `POST /api/pms/room-charge` в hotel-pms. Склад и выручка GL — события в Finance через цепочку PMS/ERP.
...
| M11 | KDS course timing | iiko KDS | **DONE** | ERPs/04 §2 |
| M12 | Recipe / BOH depletion engine | iiko storehouse | **DONE** | posting → **Finance** |
| M13 | Delivery aggregator inbox | Wolt/Glovo | **DONE** | **PLATFORM** `delivery` |
| M14 | Labor roster / PIN clock | Toast labor | **DONE** | ERPs/04 §8 |
...
OpenAPI: [fnb-pos-pms-bridge.yaml](../era-hotel-pms/doc/openapi/fnb-pos-pms-bridge.yaml)
