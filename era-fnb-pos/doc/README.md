# ERA F&B POS (`era-fnb-pos`) — пакет спецификации

> **Статус:** сателлит **era-fnb-pos** (код + спека).  
...
Код: корень репозитория `era-fnb-pos/` (Next.js :3200). PMS-мост остаётся в **era-hotel-pms** — см. [08-extraction](08-extraction-to-satellite-repo.md).
...
| **era-fnb-pos** | Ресторан/бар: зал, чеки, KDS, смена POS, меню F&B, оплата, KKM на месте |
...
| 08 | [08-extraction-to-satellite-repo.md](08-extraction-to-satellite-repo.md) | Чеклист выноса в `era-fnb-pos` |
