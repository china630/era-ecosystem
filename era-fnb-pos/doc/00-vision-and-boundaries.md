# 00. Видение и границы era-fnb-pos

## Продукт

**era-fnb-pos** — облачный сателлит **ресторанного контура** (Food & Beverage): приём заказа в зале, кухня, оплата, смена кассира POS, фискализация на месте.
