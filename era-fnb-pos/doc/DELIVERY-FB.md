...
- [x] App in monorepo `era-fnb-pos` (port 3200, Docker)
...
- [x] Auth FB_WAITER / FB_MANAGER — Variant A grants (`api:`/`screen:`/`admin:`); JWT `permissions[]`; `/admin/access` matrix
