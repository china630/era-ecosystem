...
| Claim | Minimum proof |
|-------|----------------|
| `gate[x]` | Stage-gate script exit 0 + `reports/wholesale-stage-*-signoff.md` |
...
```
reports/wholesale-stage-<wave>.log
reports/wholesale-stage-<wave>-signoff.md
reports/wholesale-pilot-lab-signoff.md
```

UAT source: `era-wholesale/doc/UAT-SMOKE.md`

## Green Scaffold BE Wave 1 (2026-08-17)

| Claim | Proof |
|-------|--------|
| AC-WS-ORD / PICK / CREDIT / PLAT Scaffold ✅ | `__tests__/ws-*-negative.spec.ts` (jest) |
| AC-WS-TENANT | Remains 🟡; **out of BE rollup** |
| Scaffold BE Product-Readiness ✅ | In-scope AC rollup only; UI/Demo/Pilot unchanged |

### UAT-SMOKE deny steps (lab)

See `era-wholesale/doc/UAT-SMOKE.md` § Green Scaffold deny paths.
