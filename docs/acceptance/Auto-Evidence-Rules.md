...
```
reports/auto-stage-<wave>.log
reports/auto-stage-<wave>-signoff.md
reports/auto-pilot-lab-signoff.md
```

UAT source: `era-auto-service/doc/UAT-SMOKE.md`
