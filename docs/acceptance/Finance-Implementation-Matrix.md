...
| AC-FIN-HR | HR payroll depth + MDM person read-through | ✅ | [ ] | `__tests__/fin-hr-negative.spec.ts` | Negative: USER denied payroll finance (OWNER/ACCOUNTANT only). UI depth still 🟡 in Readiness |
