...
- **Declared spec (not SHIPPED):** Nafta housekeeping deepen (3-axis room state, roster, ƏG, daily floor pairs, Kat Hizmetleri sheet, guest laundry) — [`era-hotel-pms/doc/HK-NAFTA-OPS.md`](../../era-hotel-pms/doc/HK-NAFTA-OPS.md) · [hotel-housekeeping-nafta-ops.md](../adr/hotel-housekeeping-nafta-ops.md). `AC-HOT-HK` scaffold ✅ is Dirty/Clean/Inspected only — not this spec; do not mark SHIPPED / Pilot / edition `ga` from the ADR alone.
