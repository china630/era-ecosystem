...
UI: `/settings/child-matrix` (full CRUD; legacy `/distribution/child-matrix` redirects). Master toggle: `/settings/pricing-policy`. Grouped under **Rates & pricing** with BAR calendar and yield rules.
