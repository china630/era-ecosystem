...
| **Industry satellites** | Read-only preview via Finance `GET /api/logistics/fx-preview` (`financeFxPreview` in satellite-kit) |
...
- Industry satellites calling `/registry/v1/fx/*` or cbar.az directly
