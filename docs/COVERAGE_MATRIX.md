...
| CP-WF-ORG-01 | Org structure (OrgUnit tree) | ADR cp-workforce-org-units | `/platform/v1/workforce/org-units/*`, `POST …/import/org-structure` | — | — | Y | — | EraListWorkspace empty grid; bootstrap + xlsx/csv import; upsert by name, no deletes |
