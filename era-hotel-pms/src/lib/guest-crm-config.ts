...
const CRM_TAB: CrmButtonConfig[] = [
  ...
  { buttonId: 'interests_hobbies', labelKey: 'crm.interests', module: 'hotel', priority: 'P2', hrefTemplate: '/guests/{id}/interests' },
  { buttonId: 'social_media', labelKey: 'crm.socialMedia', module: 'hotel', priority: 'P2', hrefTemplate: '/guests/{id}/social-media' },
  { buttonId: 'references', labelKey: 'crm.references', module: 'deferred', priority: 'P3', disabled: true, deferredReasonKey: 'crm.deferredP3' },
  { buttonId: 'general_crm', labelKey: 'crm.generalCrm', module: 'hotel', priority: 'P2', hrefTemplate: '/guests/{id}/general-crm' },
  { buttonId: 'bonus', labelKey: 'crm.bonus', module: 'deferred', priority: 'P2', disabled: true, deferredReasonKey: 'crm.deferredP2' },
  { buttonId: 'buying_habits', labelKey: 'crm.buyingHabits', module: 'pos', priority: 'P2' },
  { buttonId: 'membership_agreements', labelKey: 'crm.membershipAgreements', module: 'hotel', priority: 'P2', hrefTemplate: '/guests/{id}/membership-agreements' },
