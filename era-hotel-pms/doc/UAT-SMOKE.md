...
1b. Live dual-run: EW **Reservation Notes** (`/app/grid/allresnotes`) Extra Request `ERA-PKG DERMO` → ERA Extra Req + `PKG-DERMO` (bridge v0.3.9 + hotel ingest). FOCP list does not carry Extra Req.
