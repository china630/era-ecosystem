...
const EW_BRIDGE_I18N = {
  en: {
    ...
    ewHotel: "EW hotel",
    overlayNeedSetup: "Open Settings once and save Hotel URL + org UUID.",
    overlayLoginHint: "Sign in with ERA staff login. URL and org stay in Settings.",
    sessionExpired: "Session expired — sign in again.",
    fillLoginPassword: "Fill login and password.",
  },
  ru: {
    ...
    notLoggedIn: "Нет входа — войдите ниже.",
    ewHotel: "EW отель",
    overlayNeedSetup: "Один раз откройте Настройки: URL отеля и UUID орг.",
    overlayLoginHint: "Вход логином ERA. URL и орг остаются в Настройках.",
    sessionExpired: "Сессия истекла — войдите снова.",
    fillLoginPassword: "Укажите логин и пароль.",
  },
  az: {
    ...
    writeOn: "Yazı AÇIQ",
    writeOff: "Yazı BAĞLI",
    notLoggedIn: "Giriş yoxdur — aşağıda daxil olun.",
    ewHotel: "EW otel",
    overlayNeedSetup: "Bir dəfə Parametrlər: otel URL və org UUID saxlayın.",
    overlayLoginHint: "ERA login ilə daxil olun. URL və org Parametrlərdə qalır.",
    sessionExpired: "Sessiya bitib — yenidən daxil olun.",
    fillLoginPassword: "Login və şifrəni doldurun.",
  },
};
