...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/admin/child-matrix', destination: '/settings/child-matrix', permanent: false },
      { source: '/admin/yield-rules', destination: '/settings/yield-rules', permanent: false },
      { source: '/distribution/child-matrix', destination: '/settings/child-matrix', permanent: false },
      { source: '/distribution/yield-rules', destination: '/settings/yield-rules', permanent: false },
