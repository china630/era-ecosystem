...
SQL = """-- Doctor-confirmed FIFO planning: PROPOSED status, rotation/substitution,
...
p = Path(r"d:\My Projects\era-ecosystem\era-clinic\prisma\migrations\20260721150000_doctor_confirmed_planning")
