...
const PRINT_FIELD_LABEL: Record<string, Record<"en" | "az" | "ru", string>> = {
  ...
  OTURAQ: {
    en: "sitting fill, above navel / below chest",
    az: "oturaq (göbəkdən yuxarı, döşdən aşağı)",
    ru: "сидячий налив, выше пупка / ниже груди",
  },
  QURSAQ: { en: "to waist", az: "qurşaq (belədək)", ru: "до пояса" },
