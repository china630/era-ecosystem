...
export default function ClinicOpsShell({ children }: { children: React.ReactNode }) {
  ...
  const navItems: EraOpsNavItem[] = [
    ...
    { href: "/inpatient", label: t("inpatient"), icon: BedDouble },
    ...
    { href: "/admin/lis-profiles", label: t("lisProfiles"), icon: FileSpreadsheet },
    { href: "/admin/procedure-rules", label: t("procedureRules"), icon: GitBranch },
