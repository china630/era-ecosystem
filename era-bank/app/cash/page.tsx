...
export default function Page() {
  const t = useTranslations("pages.cash");
    ...
    <div className="space-y-4">
      ...
      <OpsModalShell open={mode === "create"} onClose={close} title={t("createTitle")}>
        <form className="space-y-3" onSubmit={onCreate}>
          ...
          <Field name="kind" label={t("kind")} preset="code" required defaultValue="TILL_TO_VAULT" />
          ...
          <Field name="reference" label={t("reference")} preset="shortText"   />
