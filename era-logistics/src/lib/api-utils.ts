...
import { requireLogisticsSatellite, IndustryModuleInactiveError } from "@/lib/logistics-module-gate";
...
export async function enterLogisticsRequestTenant(): Promise<string | undefined> {
