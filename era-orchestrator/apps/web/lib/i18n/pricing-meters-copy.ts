...
const ru: PricingMetersCopy = {
  ...
  rows: [
    ...
    { id: "cabinet", label: "Кабинет (Clinic)", included: "5 в EMR или санатории", overage: "19 AZN / кабинет" },
    { id: "bed", label: "Койка (Clinic)", included: "5 в стационаре", overage: "19 AZN / койка" },
...
const az: PricingMetersCopy = {
  ...
  rows: [
    ...
    { id: "cabinet", label: "Kabinet (Clinic)", included: "EMR və ya sanatoriyada 5", overage: "19 AZN / kabinet" },
    { id: "bed", label: "Çarpayı (Clinic)", included: "Stasionarda 5", overage: "19 AZN / çarpayı" },
