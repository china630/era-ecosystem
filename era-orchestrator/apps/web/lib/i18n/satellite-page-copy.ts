  ...
  pages: {
    ...
    hotel: {
      ...
      gateBullets: [
        ...
        "Resort-пакет: list 232 AZN × 15% = 197.20 AZN / мес",
      ],
    ...
    clinic: {
      ...
      gateTitle: "Gate vs ядро",
      gateBullets: [
        "Gate 29 AZN — приложение, квота кабинетов на модулях",
        "EMR 39 · лаборатория 29 · санаторий 99 · страховка 39",
        "5 кабинетов в EMR или санатории, 5 коек в стационаре, далее 19 AZN",
      ],
  ...
  pages: {
    ...
    hotel: {
      ...
      gateBullets: [
        ...
        "Resort paket: list 232 AZN × 15% = 197.20 AZN / ay",
      ],
    ...
    clinic: {
      ...
      gateTitle: "Gate vs nüvə",
      gateBullets: [
        "Gate 29 AZN — tətbiq, kabinet kvotası modullardadır",
        "EMR 39 · laboratoriya 29 · sanatoriya 99 · sığorta 39",
        "EMR və ya sanatoriyada 5 kabinet, stasionarda 5 çarpayı, sonra 19 AZN",
      ],
