...
export class NotificationsDispatchService {
  ...
  constructor(
    ...
    private readonly whatsappBusinessAdapter: WhatsappBusinessAdapter,
  ...
  private async dispatchChannel(
    ...
    switch (channel) {
      ...
      case NotificationChannel.WHATSAPP: {
        if ((process.env.WHATSAPP_BUSINESS_MODE ?? "").toLowerCase() === "live") {
          return this.whatsappBusinessAdapter.send({
            to: input.recipient,
            body: input.body,
            templateName:
