...
export class BookingController {
  ...
  createAppointment(
    ...
    return this.booking.createAppointment(organizationId, body, idempotencyKey);
  }

  @Post("appointments/:id/cancel")
  @ApiOperation({ summary: "Cancel appointment (Live — webhooks + policy)" })
  cancelAppointment(
    @OrganizationId() organizationId: string,
    @Param("id") id: string,
    ...
    return this.booking.cancelAppointment(
      organizationId,
      id,
      body?.reason,
      idempotencyKey,
