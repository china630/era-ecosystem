...
export class BillingController {
  ...
  async activatePremium(
    ...
    await this.access.assertOwnerForBilling(user.sub, organizationId);
  ...
  async billingSummary(@CurrentUser() user: EraJwtPayload) {
    return this.billingPlatform.getSummary(user.sub);
  }
  ...
  async billingInvoices(
    ...
    return this.billingPlatform.listInvoices(user.sub, safePage, safeSize);
  }
  ...
  async listPaymentOrders(@CurrentUser() user: EraJwtPayload) {
    return this.paymentOrders.listForOwnerUser(user.sub);
  }
  ...
  async toggleModule(
    ...
    return this.billingToggle.toggle(user.sub, organizationId, dto);
  }
  ...
  async toggleBundle(
    ...
    return this.billingBundleToggle.toggle(user.sub, organizationId, dto);
  }
