...
| M11 | KDS course timing | iiko KDS | **MVP** | ERPs/04 §2 |
| M12 | Recipe / BOH depletion engine | iiko storehouse | **MVP** | posting → **Finance** |
| M13 | Delivery aggregator inbox | Wolt/Glovo | **MVP** | **PLATFORM** `delivery` |
| M14 | Labor roster / PIN clock | Toast labor | **PLANNED (v1.1)** | ERPs/04 §8 |
